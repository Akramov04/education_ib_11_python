...
def picture(file_name, width, height, sky_color="#87CEEB", ocean_color="#017B92", ship_color="#874535",
    ...
    drawer.polygon(((int(0.25 * width), int(0.65 * height)),
                    ...
                    (int(0.3 * width), int(0.85 * height))), ship_color)
...
picture('./assets/test.bmp', 1000, 800)